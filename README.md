...
<hr/>
<img src="docs/images/fig1.png", style="width:80%;margin-left:auto;margin-right:auto;display:block;">
...
<br/><br/><br/>
<img src="docs/images/fig3.png", style="width:80%;margin-left:auto;margin-right:auto;display:block;">
In this paper, we introduce quantization margin variable, ξ, allowing values in the vicinity of 0.5 to match both 0 and 1. 
<br/><br/><br/>
<img src="docs/images/fig4.png", style="width:80%;margin-left:auto;margin-right:auto;display:block;">
...
<br/><br/><br/>
<img src="docs/images/fig5.png", style="width:80%;margin-left:auto;margin-right:auto;display:block;">
